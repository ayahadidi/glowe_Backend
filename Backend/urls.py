...
from .views.ratingview import  AddRatingView
...
urlpatterns = [
    ...
    path('api/add_ratings/<uuid:product_uuid>/', AddRatingView.as_view(), name='add_rating'),
    path('api/avg_ratings/<uuid:product_uuid>/', AddRatingView.as_view(), name='add_rating'),
